/* =========================================================
   ...
   Responsibilities:
     ...
     • Interface with local JSON data (chemo, heparin, insulin)
   ---------------------------------------------------------
   Notes:
...
fetch("data/protocols/heparinProtocols.json")
    ...
    .then(data => {
        ...
        if (typeof window !== "undefined") window.clinicalGuidelines = data;
    })
...
function navigateToSection(id) {
    ...
    else if (id === "medications") loadMedicationsMenu();
    }
...
function openLeukemiaType(type) {
    ...
    document.getElementById("typeTitle").innerText = `${type} Chemotherapy Protocols`;
